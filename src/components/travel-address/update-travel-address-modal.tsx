...
import { TravelAddressDTO, UpdateTravelAddressDTO } from "@/types/dtos";
import { travelAddressService } from "@/services/travel-address-service";
import { useToast } from "@/contexts/toast-context";



export default function UpdateTravelAddressModal({
    travelId,
    travelAddress,
    isOpen,
    onClose
    ...
    const travelAddressId: number = travelAddress.id!;
    ...
    const mutation = useMutation({
        mutationFn: async (data: UpdateTravelAddressDTO) => {
            return await travelAddressService.updateTravelAddress(travelId, travelAddressId, data);
        },
        onSuccess: () => {
